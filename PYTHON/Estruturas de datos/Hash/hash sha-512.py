...
def Hash_sha512(cadena):
    """Calcula el hash SHA-512 de una cadena y lo devuelve como entero."""
    hash_obj = hashlib.sha512(cadena.encode('utf-8'))
